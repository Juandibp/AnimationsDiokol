...
local a = 0.01;                -- five wings
local m = math.cos(4*PI/5) + 0.008; -- five wings
local b = 0.05;
local cx = 1; -- value of current x
local cy = 1; -- value of current y
local d = 1; -- diameter of an ellipse
local s = 0.05; -- change scale of the map
